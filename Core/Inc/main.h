...
#define EXT_SHIELD_LED8_Pin GPIO_PIN_6
#define EXT_SHIELD_LED8_GPIO_Port GPIOB
...
#define NS_Pin GPIO_PIN_2
#define NS_GPIO_Port GPIOI
...
#define NUCLEO_EXT_SHIELD_LED8_Pin GPIO_PIN_8
#define NUCLEO_EXT_SHIELD_LED8_GPIO_Port GPIOA
