...
/* Includes ------------------------------------------------------------------*/
#include "stm32f746g_disco_bus.h"
...
#define HCI_TL_SPI_CS_PORT    GPIOF
#define HCI_TL_SPI_CS_PIN     GPIO_PIN_10

#define HCI_TL_RST_PORT       GPIOI
#define HCI_TL_RST_PIN        GPIO_PIN_3
